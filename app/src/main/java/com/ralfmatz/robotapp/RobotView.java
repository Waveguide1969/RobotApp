...
public class RobotView extends View {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mExampleString = a.getString(
                R.styleable.RobotView_exampleString);
        mExampleColor = a.getColor(
                R.styleable.RobotView_exampleColor,
                mExampleColor);
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.RobotView_exampleDimension,
                mExampleDimension);

        if (a.hasValue(R.styleable.RobotView_exampleDrawable)) {
            mExampleDrawable = a.getDrawable(
                    R.styleable.RobotView_exampleDrawable);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        RobotStyleKit.drawRobotHead(canvas);
    }
}
